# StackSolve - 栈问速解 API 测试脚本

## 概述

本测试套件为 StackSolve - 栈问速解 项目提供了全面的API接口测试，涵盖认证、系统管理、对话等核心功能模块。
...
├── test_crawl4ai.py           # crawl4ai 完整测试
├── test_crawl4ai_quick.py     # crawl4ai 快速测试
...
### crawl4ai 测试
- ✅ **test_crawl4ai.py**: 完整的 crawl4ai 功能测试
  - 模块导入检查
  - Playwright 浏览器检查
  - ensure_playwright_browser 函数测试
  - 简单网页爬取测试
  - 复杂网页爬取测试（JavaScript 渲染）
  - 自定义配置爬取测试

- ✅ **test_crawl4ai_quick.py**: 快速测试脚本
  - 快速检查 crawl4ai 是否可用
  - 适合在部署后快速验证
...
# crawl4ai 测试
uv run python test/test_crawl4ai.py          # 完整测试
uv run python test/test_crawl4ai_quick.py    # 快速测试
```
