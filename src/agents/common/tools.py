...
def get_buildin_tools() -> list:
    ...
    try:
        ...
        from src.agents.common.toolkits.git.tools import get_git_tools

        tools.extend(get_git_tools())

        from src.agents.common.toolkits.bash.tools import get_bash_tools

        tools.extend(get_bash_tools())

        from src.agents.common.toolkits.web_crawler.tools import get_web_crawler_tools

        tools.extend(get_web_crawler_tools())
