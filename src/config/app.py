...
class Config(SimpleConfig):
    def __init__(self):
        ...
        self.add_item("model_provider", default="dashscope", des="模型提供商", choices=list(self.model_names.keys()))
        self.add_item("model_name", default="wwwrnnn/qwen2.5-VL-7B-lora", des="模型名称")
        self.add_item(
            "fast_model",
        ...
        self.add_item(
            "vl_model",
            default="siliconflow/OpenGVLab/InternVL2-26B",
            des="视觉语言模型（VL Model）",
        )
