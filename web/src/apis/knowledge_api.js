...
export const documentApi = {
   ...
   * @returns {Promise} - 更新结果
   */
  updateDocumentFilename: async (dbId, docId, newFilename) => {
    return apiAdminPut(`/api/knowledge/databases/${dbId}/documents/${docId}/filename`, {
   ...
   * @returns {Promise} - 更新结果
   */
  updateChunkContent: async (dbId, docId, chunkId, newContent) => {
    return apiAdminPut(`/api/knowledge/databases/${dbId}/documents/${docId}/chunks/${chunkId}`, {
