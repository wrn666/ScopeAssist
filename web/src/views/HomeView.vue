    ...
    <div class="hero-section">
      <div class="glass-header">
        <div class="logo">
          ...
          <span style="font-size: 1.3rem; font-weight: bold;">ScopeAssist</span>
        </div>
        <nav class="nav-links">
      ...
      <div class="hero-content">
        <h1 class="title">
          <span>ScopeAssist</span>
          <span>基于魔搭的社区智答助手</span>
        </h1>
...
const goToChat = async () => {
  ...
  try {
    ...
    // 尝试获取默认智能体ID
    if (agentStore.defaultAgentId && agentStore.agents[agentStore.defaultAgentId]) {
      // 如果存在默认智能体，直接跳转
